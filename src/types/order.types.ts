...
import { ILaundryService } from './laundryservice';
...
export interface IOrderItem {
  productId: Product; // Laundry product (e.g., "Shirt Wash & Iron")
  productName?: string; // Snapshot (for history)
  serviceId: ILaundryService; // Specific service variant
  serviceName?: string;
  quantity: number;
  unitPrice: number; // Price per piece/kg at time of order
  attributeValues: {
    attributeId: TAttribute;
    optionId: string;
